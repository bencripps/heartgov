...
* @Last Modified time: 2016-07-01 14:58:04
*/
...
module.exports = function(mongoose, TextSchema, AdminSchema, shortId, appMessages) {
    ...
    var austinShortHandler = {
        ...
        sendAndSave: function(message, outGoingResponse, twilioWrapper) {
            ...
            twilioWrapper.sendOutGoingText(outGoingResponse, message.from, null, null, null, '/austinShort/database');
        },
        ...
        getTextModel: function(message, outGoingResponse) {
                var cityInfo = appMessages.cities.filter(function(ob){ return ob.name === 'austin-short';})[0];
                ...
                return {
                    ...
                    textInformation: {
                        ...
                        status: null,
                        zipcode: null,
                        responders: [austinShortHandler.formatOutGoingResponseForSave(outGoingResponse, message.from)],
