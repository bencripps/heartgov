...
* @Last Modified time: 2016-01-28 19:35:30
*/
...
module.exports = function(mongoose, TextSchema, AdminSchema, shortId, appMessages) {
    ...
    var haverhillHandler = {
        ...
        handleOutgoingResponse: function(msg, twilioWrapper, previousMessages) {
            ...
            if (previousMessages.length < appMessages.haverhillConfig.questions.length) {
                outgoingMsg = appMessages.haverhillConfig.questions[previousMessages.length];
            }

            else {
                outgoingMsg = appMessages.haverhillConfig.questions[appMessages.haverhillConfig.questions.length - 1];
            }
        ...
        sendAndSave: function(message, outGoingResponse, twilioWrapper) {
            ...
            twilioWrapper.sendOutGoingText(outGoingResponse, message.from, null, null, null, '/haverhill/database');
        },
        ...
        getTextModel: function(message, outGoingResponse) {
                var cityInfo = appMessages.cities.filter(function(ob){ return ob.name === 'haverhill';})[0];
                ...
                return {
                    ...
                    textInformation: {
                        ...
                        status: null,
                        zipcode: null,
                        responders: [haverhillHandler.formatOutGoingResponseForSave(outGoingResponse, message.from)],
